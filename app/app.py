...
prediction_counter = Counter(
    "churn_predictions_total", "Total number of churn predictions made", ["will_churn"]
)

churn_probability_histogram = Histogram(
    "churn_probability", "Distribution of churn probabilities"
)
...
async def predict(req: ChurnRequest):
    ...
    try:
        ...
        prediction_counter.labels(will_churn=str(will_churn)).inc()
